    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">내 포트폴리오</h1>
          <p className="text-gray-600">나만의 투자 아바타를 관리하고 추적하세요</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          {isLoading ? (
            ...
            <div className="p-8">
              <ErrorBox
                message={error?.message || "아바타를 불러오는데 실패했습니다. 잠시 후 다시 시도해주세요."}
              />
            ...
            <div className="text-center py-16 px-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">아바타를 찾을 수 없습니다</h3>
